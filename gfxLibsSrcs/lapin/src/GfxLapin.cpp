...
arcade::GfxLapin::GfxLapin() {
	font = bunny_load_picture("font.png");
	if (!font)
...
void arcade::GfxLapin::printText(t_bunny_picture *font, t_bunny_buffer *pic, const t_bunny_position *p, const char *str, bool up) {
